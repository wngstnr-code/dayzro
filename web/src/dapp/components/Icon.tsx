...
// Ported 1:1 from the reference bridge UI icon set (Svelte).
...
function paths(type: IconType, fillClass: string) {
    switch (type) {
        case 'bridge':
            return (
                <>
        ...
        case 'chevron-left':
            return (
                <>
                    <path className="stroke-primary-icon" fill="none" strokeWidth="2" d="M15 3 L8 10 L15 17" />
                </>
            );
        case 'chevron-right':
            return (
                <>
                    <path className="stroke-primary-icon" fill="none" strokeWidth="2" d="M5 3 L12 10 L5 17" />
                </>
            );
        case 'x-close':
            return (
            ...
            return (
                <>
                    <circle
                          ...
                          r="10"
                          fill="none" />
                        <circle fillRule="evenodd" clipRule="evenodd" className={fillClass} cx="10" cy="10" r="5" fill="none" />
                </>
            );
        case 'circle':
            return (
                ...
                <>
                    <defs>
                        ...
                        <path
                          ...
                          style={{fill:'#FF7A3D',strokeWidth:'0px'}} />
                        <path
                          ...
                          style={{fill:'url(#b)',strokeWidth:'0px'}} />
                        <path
                          ...
                          style={{fill:'#FFD9C2',strokeWidth:'0px'}} />
                </>
            );
        case 'bridge-dark':
            return (
                <>
                    <defs>
                        ...
                        <path
                          d="m2.89,19.5c-.63,0-1.24-.25-1.69-.7-.45-.45-.7-1.06-.7-1.69v-6.91c0-.63.25-1.24.7-1.69.45-.45,1.06-.7,1.69-.7h1.33v3.99c0,1.06.42,2.07,1.17,2.82.75.75,1.76,1.17,2.82,1.17h3.99v1.33c0,.63-.25,1.24-.7,1.69-.45.45-1.06.7-1.69.7H2.89Z"
                          style={{fill:'#f3f3f4',strokeWidth:'0px'}} />
                </>
            );
        case 'success-light':
            return (
                <>
                    <circle cx="10" cy="10" r="9.5" style={{fill:'#005e36',isolation:'isolate',opacity:'.05',strokeWidth:'0px'}} />
                        <ellipse cx="10" cy="10" rx="7.01" ry="7" style={{fill:'#005e36',isolation:'isolate',opacity:'.2',strokeWidth:'0px'}} />
                        <path
                          ...
                          style={{fill:'#005e36',fillRule:'evenodd',strokeWidth:'0px'}} />
                </>
            );
        case 'success-dark':
            return (
                <>
                    <circle cx="10" cy="10" r="9.5" style={{fill:'#69c396',isolation:'isolate',opacity:'.05',strokeWidth:'0px'}} />
                        <path
                          ...
                          style={{fill:'#69c396',fillRule:'evenodd',strokeWidth:'0px'}} />
                </>
            );
        case 'approve-light':
            return (
                <>
                    <path
                          ...
                          style={{fill:'#FF7A3D',fillRule:'evenodd',strokeWidth:'0px'}} />
                        <rect x="11.34" y="16.55" width="7.66" height="2.95" style={{fill:'#FF7A3D',strokeWidth:'0px'}} />
                        <path
                          ...
                          style={{fill:'#e7e7e7',strokeWidth:'0px'}} />
                </>
            );
        case 'approve-dark':
            return (
                ...
                <>
                    <defs>
                        ...
                        <path
                          ...
                          style={{fill:'#fafbfb',strokeWidth:'0px'}} />
                </>
            );
        case 'settings':
            return (
...
export function Icon({ type, size = 20, width, height, fillClass = "fill-primary-icon", className }: IconProps) {
    return (
        <svg
            width={width ?? size}
            height={height ?? size}
